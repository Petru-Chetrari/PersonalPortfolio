...
<div class="flex w-full overflow-hidden" style="border-radius: inherit; min-height: 700px;">
    ...
    <div class="flex flex-col gap-1 p-3 flex-1">
      {#each projects as project}
        ...
        >
          ...
          <span style="color: #64748B; font-size: 12px; font-weight: 500; margin-top: 2px;">
            {project.appType}
          </span>
        </button>
      {/each}
  ...
  >
    {#if selectedProject}
      ...
      <div
        ...
        style="border-bottom: 1px solid #334155; background: rgba(30,41,59,0.5);"
      >
        <h2 style="color: #F8FAFC; font-size: 18px; font-weight: 700; margin: 0;">
          Project Details
        </h2>
        <div style="display: flex; gap: 10px; align-items: center;">
          ...
          >
            <svg width="13" height="13" viewBox="0 0 20 20" fill="none" style="flex-shrink:0">
              <path d="M14.7 2.29a1 1 0 0 1 1.41 0l1.6 1.6a1 1 0 0 1 0 1.42L5.46 17.56 2 18l.44-3.46L14.7 2.29Z"
          ...
          <button
            ...
            onmouseenter={(e) => (e.currentTarget.style.background = 'rgba(255,32,86,0.2)')}
            onmouseleave={(e) => (e.currentTarget.style.background = 'rgba(255,32,86,0.1)')}
          >
            <svg width="13" height="13" viewBox="0 0 20 20" fill="none" style="flex-shrink:0">
              <path d="M4 6h12M15.33 6v9.33A1.33 1.33 0 0 1 14 16.67H6a1.33 1.33 0 0 1-1.33-1.34V6M7.33 6V4.67A1.33 1.33 0 0 1 8.67 3.33h2.66A1.33 1.33 0 0 1 12.67 4.67V6M8.67 9.33v4M11.33 9.33v4"
                stroke="#FF2056" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            Delete
          </button>
        </div>
      ...
      <div class="flex flex-col px-8 py-7 gap-8 pb-12">
        ...
        <div>
          ...
          <h1 style="color: #F8FAFC; font-size: 30px; font-weight: 700; line-height: 1.2; margin: 0;">
        ...
        <div>
          <span class="field-label" style="display: flex; align-items: center; gap: 6px;">
            <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
              <rect x="1" y="2" width="14" height="12" rx="2" stroke="#3B82F6" stroke-width="1.2"/>
              <circle cx="5.5" cy="6" r="1.5" stroke="#3B82F6" stroke-width="1.2"/>
              <path d="M1 11l3.5-3.5L7 10l3-3 5 5" stroke="#3B82F6" stroke-width="1.2" stroke-linecap="round"/>
            </svg>
            Photos
          </span>
          <div
        ...
        <div>
          ...
          <div style="color: #CBD5E1; font-size: 14px; line-height: 1.75; white-space: pre-wrap;">
        ...
        <div>
          <span class="field-label" style="display: flex; align-items: center; gap: 6px;">
            <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
              <path d="M6.5 9.5a3 3 0 0 0 4.243 0l2-2a3 3 0 0 0-4.243-4.243L7.4 4.36M9.5 6.5a3 3 0 0 0-4.243 0l-2 2a3 3 0 0 0 4.243 4.243L8.6 11.64"
                stroke="#3B82F6" stroke-width="1.2" stroke-linecap="round"/>
            </svg>
            Links &amp; Metadata
          </span>
          <div
          ...
          >
            <div>
              <div style="color: #64748B; font-size: 9px; font-weight: 800; letter-spacing: 0.18em; text-transform: uppercase; margin-bottom: 6px;">
                Category
              </div>
    ...
    {:else}
      <div style="flex: 1; display: flex; align-items: center; justify-content: center; padding: 48px;">
        <div style="text-align: center; border: 2px dashed #334155; border-radius: 24px; padding: 40px 48px;">
          <p style="color: #F8FAFC; font-size: 17px; font-weight: 700; margin: 0 0 8px;">No Project Selected</p>
          <p style="color: #94A3B8; font-size: 13px; margin: 0;">Select a project from the sidebar to view its details.</p>
        </div>
      </div>
    {/if}
  </main>
